...
export const ScheamaProductos = Yup.object().shape({
  ...
  destacado: Yup.string().required('El campo es requerido')
});

export const ScheamaEnvios = Yup.object().shape({
  distrito: Yup.string().required("El campo es requerido"),
  precio: Yup.string().required("El campo es requerido"),
});
...
export const SchemaBanners = Yup.object().shape({
...
export const SchemaConfiguracion = Yup.object().shape({
  ...
  horario: Yup.string().required("El campo es requerido"),
  precio1: Yup.string().required("El campo es requerido"),
  precio2: Yup.string().required("El campo es requerido"),
...
export const SchemaImprenta = Yup.object().shape({
