...
import { subcategoriasValues } from '../../../shared/Interfaces'

export const ListaSubcategorias = (): JSX.Element => {
  ...
  const getAllProductos = async (): Promise<void> => {
    ...
    const request = await axios.post(`${Global.url}/getSubcategorias`, data, {
      headers: {
  ...
  useEffect(() => {
    setTitle('Listado de subcategorias')
    getAllProductos()
  }, [])
      ...
      {loadingComponents
        ...
        <div className="bg-secondary-100 p-8 rounded-xl">
          <div className="hidden md:grid grid-cols-1 md:grid-cols-4 gap-4 mb-10 p-4">
            ...
            <h5 className="md:text-center">Subcategoría</h5>
            <h5 className="md:text-center">Categoría</h5>

            <h5 className="md:text-center">Acciones</h5>
          </div>
          {filterDate().map((pro: subcategoriasValues) => (
            <div
            ...
            >
              ...
              <div className="md:text-center">
                <h5 className="md:hidden text-white font-bold mb-2">Subcategoría</h5>
              ...
              <div className="md:text-center md:flex md:justify-center">
                ...
                <span className="text-center line-clamp-1">{pro.categoria}</span>
