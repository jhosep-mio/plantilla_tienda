...
import { type imprentaValuesModificate } from '../../../shared/Interfaces'
import { DeleteItems } from '../../../shared/DeleteItems'
import { LoadingSmall } from '../../../shared/LoadingSmall'

export const ListarBlogs = (): JSX.Element => {
  ...
  const getAllProductos = async (): Promise<void> => {
    ...
    const request = await axios.post(`${Global.url}/getBlogs`, data, {
      headers: {
      ...
      {loadingComponents
        ...
        <div className="bg-secondary-100 p-8 rounded-xl">
          <div className="hidden md:grid grid-cols-1 md:grid-cols-4 gap-4 mb-10 p-4">
            ...
            <h5 className="md:text-center">Título</h5>
            <h5 className="md:text-center">Imagen</h5>
            <h5 className="md:text-center">Acciones</h5>
          </div>
          {filterDate().map((pro: imprentaValuesModificate) => (
            <div
            ...
            >
              ...
              <div className="md:text-center md:flex md:justify-center">
                ...
                <img
                  src={`${Global.urlImages}/blogs/${pro.imagen1}`}
                  alt=""
