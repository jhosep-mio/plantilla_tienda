...
export const AddProducto2: React.FC<ComponentProps> = ({
  ...
  return (
    <>
      <button
        className="w-full gap-2 bg-paleta-500 hover:bg-paleta-500/80 transition-colors px-2 md:px-6 py-2 md:py-3 rounded-md text-white text-sm md:text-base flex items-center justify-center"
        onClick={(e) => {
          e.preventDefault()
